											...
											<div class="post-archive post-archive--grid lsvr_listing-post-page lsvr_listing-post-archive lsvr_listing-post-archive--grid post-archive--layout-style-dark">
												...
												<header class="main-header">
													<div class="main-header__inner">
														...
														<h1 class="main-header__title">Vietas</h1>
														...
														<?php
														$result2 = mysqli_query($conn,"SELECT * FROM activities INNER JOIN act_category ON activities.category_id = act_category.id_category");
												...
												$page_no = $_GET['page_no'];
													...
													$result_count = mysqli_query(
														$conn,
														"SELECT COUNT(*) As total_records FROM `activities`"
														);
                               						 ...
                               						 $result = mysqli_query($conn,"SELECT * FROM activities INNER JOIN act_category ON activities.category_id = act_category.id_category LIMIT $offset, $total_records_per_page");
														...
														<article class="post post--has-thumbnail">
															<div class="post__inner">
																...
																<p class="post__thumbnail post__thumbnail--cropped">
																	<a href="/detail/place-detail?id=<?php echo $row["id_activities"] ?>" class="post__thumbnail-link post__thumbnail-link--cropped" style="background-image: url( '<?php echo 'data:image/png;base64,' . $row["picture"] . ''; ?>' );">
																...
																<div class="post__container">
																	...
																	<header class="post__header">
																		...
																		<p class="post__categories" title="Category">
																			<span class="post__terms post__terms--lsvr_listing_cat">
																				<a href="/archive/places-archive" class="post__term-link"><?php echo $row["cname"] ?></a>
																			</span>
																		</p>
																		<!-- POST CATEGORIES : end -->
																		...
																		<h2 class="post__title">
																			<a href="/detail/places-detail?id=<?php echo $row["id_activities"] ?>" class="post__title-link" rel="bookmark"><?php echo $row["aname"] ?></a>
																		</h2>
																		<!-- POST TITLE : end -->
																	...
																	<p class="post-permalink">
																		<a href="/detail/places-detail?id=<?php echo $row["id_activities"] ?>" class="post-permalink__link" rel="bookmark">
